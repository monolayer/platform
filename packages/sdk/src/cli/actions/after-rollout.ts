...
import { addAfterRolloutWorkload } from "~workloads/scaffolding/lifecycle.js";

export function afterRollout(command: Command) {
	return command
		.command("after-rollout")
		.description("add an after rollout workload")
		.action(async () => {
