...
type DeploymentStatus = "Queued" | "Ongoing" | "Finished" | "Failed" | "Unknown";
...
export default class DeploymentsDeploy extends Command {
	...
	public async run(): Promise<DeployCommandResult> {
		...
		const triggerResponse = await this.sendJsonRequest<DeploymentTriggerResponse>(
	...
	}): Promise<{ readonly status: DeploymentStatus; readonly logs: DeploymentLog[] }> {
