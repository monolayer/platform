...
JavaScript Object Notation (JSON) is the default output format for `projects:list` and the `env` commands.
...
| `env:list`           | Lists project environment variables.                    | JSON            |
| `env:set`            | Creates or updates an environment variable.             | JSON            |
| `env:delete`         | Deletes an environment variable.                        | JSON            |
