import { Entity, type FormattedItem } from "dynamodb-toolbox";
export declare const CronTask: Entity<"CRON_TASK", import("dynamodb-toolbox").Table<{
    name: "PK";
    type: "string";
}, {
    name: "SK";
    ...
    PK: import("dynamodb-toolbox").StringSchema<{
        key: true;
        required: "always";
        transform: import("dynamodb-toolbox/transformers/prefix").Prefixer<"PROJECT_ENVIRONMENT", "-">;
    }>;
    SK: import("dynamodb-toolbox").StringSchema<{
        key: true;
        required: "always";
        transform: import("dynamodb-toolbox/transformers/prefix").Prefixer<"CRON_TASK", "-">;
    }>;
...
export type FormattedCronTask = FormattedItem<typeof CronTask>;
