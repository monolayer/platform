...
export declare const Deployment: Entity<
	"DEPLOYMENT",
		...
		deploymentProgress: import("dynamodb-toolbox").MapSchema<
			{
				all: import("dynamodb-toolbox").StringSchema<{
					enum: [
						...
						"IN_PROGRESS",
						"IMAGE_BUILD",
						"EDGE_AND_LB_PROVISION",
						"STATEFUL_WORKLOADS_DEPLOY",
						"STATELESS_WORKLOADS_DEPLOY",
						"STATEFUL_WORKLOADS_DELETE",
						"CANCEL_IN_PROGRESS",
						"CANCEL_COMPLETE",
						"FAILED",
						"SUCCESS",
				...
				stacks: import("dynamodb-toolbox").ListSchema<
					import("dynamodb-toolbox").MapSchema<
						{
...
>;
export declare function assertDeployment(
	image: unknown,
): asserts image is Deployment;
export type Deployment = TransformedItem<typeof Deployment>;
export type FormattedDeployment = FormattedDeployment;
type EventStatusProgress = Extract<
	ProgressState,
	"PENDING" | "IN_PROGRESS" | "FAILED" | "SUCCESS"
>;
export type DeploymentProgress = InputValue<
	(typeof Deployment)["schema"]
>["deploymentProgress"];
...
export declare function updateStackProgress(
	stackProgressArray: StackProgress[],
	name: string,
	stackName: string,
	progress: DeploymentProgressState,
): StackProgress[];
...
export declare function parseDeployment(record: StreamRecord):
	...
	| undefined;
export declare const DeploymentRepository: EntityRepository<
	Entity<
		"DEPLOYMENT",
		import("dynamodb-toolbox").Table<
			{
