...
export declare const Environment: Entity<
	"ENVIRONMENT",
	...
	>,
	{
		...
		resources: import("dynamodb-toolbox").RecordSchema<
			import("dynamodb-toolbox").StringSchema<{}>,
			import("dynamodb-toolbox").RecordSchema<
				import("dynamodb-toolbox").StringSchema<{}>,
		...
		availabilityZoneNames: import("dynamodb-toolbox").ListSchema<
			import("dynamodb-toolbox").StringSchema<{}>,
			{
				putDefault: unknown;
			}
		...
		network: import("dynamodb-toolbox").MapSchema<
			{
				...
				publicSubnets: import("dynamodb-toolbox").ListSchema<
					import("dynamodb-toolbox").StringSchema<{}>,
					{
						putDefault: unknown;
					}
				>;
				privateSubnets: import("dynamodb-toolbox").ListSchema<
					import("dynamodb-toolbox").StringSchema<{}>,
					{
						putDefault: unknown;
					}
...
export type FormattedEnvironment = FormattedEnvironment;
export type InputEnvironment = InputItem<typeof Environment>;
export declare const EnvironmentRepository: EntityRepository<
	Entity<
		"ENVIRONMENT",
		import("dynamodb-toolbox").Table<
			{
