...
export declare const Project: Entity<
	"PROJECT",
	...
	>,
	{
		...
		environmentVariables: import("dynamodb-toolbox").ListSchema<
				...
				certificate: import("dynamodb-toolbox").MapSchema<
					{
						...
						resourceRecord: import("dynamodb-toolbox").ListSchema<
							import("dynamodb-toolbox").MapSchema<
								{
...
>;
export declare function assertProjectRecord(
	image: unknown,
): asserts image is ProjectRecord;
export type ProjectRecord = TransformedItem<typeof Project>;
export type ReadProject = DecodedItem<typeof Project>;
export type FormattedProject = FormattedProject;
...
export declare const ProjectRepository: EntityRepository<
	Entity<
		"PROJECT",
		import("dynamodb-toolbox").Table<
			{
	...
	>
>;
export type CustomDomainStatus = NonNullable<
	NonNullable<FormattedProject["customDomain"]>["status"]
>;
