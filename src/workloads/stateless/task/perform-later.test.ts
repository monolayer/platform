...
import { PerformOptions, Task } from "~/workloads/stateless/task/task.js";

vi.mock(
	import("~/workloads/stateless/task/dispatcher.js"),
	async (importOriginal) => {
		const actual =
			(await importOriginal()) as typeof import("~/workloads/stateless/task/dispatcher.js");
		return {
			...actual,
